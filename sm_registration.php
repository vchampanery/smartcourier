...
<head>
	...
	<link rel="stylesheet" type="text/css" href="layout/public/scroll.css">
		...
		<div class="row">
	    	<?php include "layout/header.php"; ?>
	     	...
	     	<div class="col-sm-8 m-auto d-block" style="height: 400px;">
				...
				<form action="sm_registration_code.php" onsubmit="return validaion()" class="bg-light" method="POST">
					<!--<div class="dropdown">
