					...
					<table id="myTable">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="sm_user_edit.php?id=<?php echo $value['id'];?>" >edit</a>&nbsp;<a href="javascipt:void(0);" onclick="deleteconfirm(<?php echo $value['id'];?>);">delete</a></td>
							</tr>
							<?php
							}?>
						</tbody>
	...
	<script >
		function deleteconfirm(id){
			...
			if(confirm_value == true){
				window.location = "sm_user_delete.php?id="+id;
			}
		}
